...
import type { ExtensionContext, Range, DecorationOptions, TextEditorDecorationType } from 'vscode';
...
function initUnderline(context) {
    ...
    // 初始化时检查已打开的文档
    updateDecorations(vscode.window.activeTextEditor!.document, lineDecorationType);
}
...
function updateDecorations(document, decorationType: TextEditorDecorationType) {
